...
<body>
    ...
    <main class="main-content">
        ...
        <div class="page-header">
            ...
            <p class="page-subtitle">Discover the latest and greatest games just added to our store</p>
        </div>
        ...
        <div class="games-container">
            ...
            ?>
                <div class="empty-state">
                    ...
                    <h3>No New Games Yet</h3>
                    <p>We're working on adding new games to our collection. Check back soon!</p>
    ...
    <div id="wishlist-notification" class="wishlist-notification">
        <img src="image/heart_yellow.svg" class="heart-icon heart-yellow">
        <span class="wishlist-message">Game added to wishlist!</span>
    </div>
