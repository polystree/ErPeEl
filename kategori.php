...
$kategori_query = mysqli_query($con, "SELECT nama FROM kategori WHERE id = '$kategori_id'");
$kategori_data = mysqli_fetch_assoc($kategori_query);
$kategori_nama = $kategori_data ? $kategori_data['nama'] : 'Unknown Category';
...
// Query for category games
$sql = "SELECT p.* FROM produk p WHERE p.kategori_id = '$kategori_id' ORDER BY $order_by LIMIT 20";
$select_produk = mysqli_query($con, $sql) or die('Query failed: ' . mysqli_error($con));

// Get all categories for sidebar
$all_categories_query = mysqli_query($con, "SELECT id, nama FROM kategori ORDER BY nama");
$all_categories = [];
while ($cat_row = mysqli_fetch_assoc($all_categories_query)) {
...
<head>
    ...
    <meta name="description" content="Browse <?php echo htmlspecialchars($kategori_nama); ?> games at Vault - Your digital game store">
    <title><?php echo htmlspecialchars($kategori_nama); ?> Games - Vault Digital Store</title>
    ...
    <main class="main-content" id="main-content">
        <div class="content-layout">
            ...
            <div class="main-section">
                <div class="search-header">
                    <div class="search-title-row">
                        <h1 class="section-title">
                            <?php echo htmlspecialchars($kategori_nama); ?> Games
                        </h1>
                        <div class="search-filters">
                            <form method="GET" action="kategori.php" class="sort-form">
                ...
                <section class="game-sections" aria-labelledby="category-results-title">
                    <div class="game-container" role="list" aria-label="Category games" id="category-results-container">
                        <?php
                        if (mysqli_num_rows($select_produk) > 0) {
                            ...
                            <div class="empty-message">
                                <div class="empty-content">
                                    ...
                                    <p>Try browsing other categories or check out our latest releases!</p>
